...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Games", path: "/games", roles: ["administrator", "director"] },
  { label: "Bet Types", path: "/bet-types", roles: ["administrator", "director"] },
  ...
  { label: "Inventory", path: "/inventory", roles: ["cashier", "administrator", "director"] },
