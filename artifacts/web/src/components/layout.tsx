...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Gross Entries", path: "/entries/gross", roles: ["gross_entry", "administrator", "director", "agent"] },
  { label: "Wins Entries", path: "/entries/wins", roles: ["wins_entry", "administrator", "director", "agent"] },
